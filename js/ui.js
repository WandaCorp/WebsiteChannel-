  ...
  try {
    ...
    if (docSnap.exists()) {
      ...
      updateLoginModalInfo(
        data['avatar-channel'] || 'https://i.postimg.cc/zX1nWKGr/default-profile-channel.jpg',
